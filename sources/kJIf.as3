...
package
{
	...
	public class SmolderEffect extends Sprite
	{
		...
		private function init(e:Event):void {	// ここから開始
			...
			_particle.blendMode = BlendMode.SUBTRACT // MULTIPLY can be used (Though it is necessary to darken the color of particle). 
			addChild(_particle);
			_twincle = new Bitmap();
			_twincle.blendMode = BlendMode.SUBTRACT;
