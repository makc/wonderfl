...
package {
    ...
    public class FlashTest extends Sprite {
        ...
        private function init(e:Event = null):void 
        {
            ...
            loaderArray[2].load(new URLRequest("http://chococornet.sakura.ne.jp/img/background_night_2.png"), new LoaderContext(true));
            loaderArray[2].name = "night";
            loaderArray[3].load(new URLRequest("http://chococornet.sakura.ne.jp/img/background_midnight.png"), new LoaderContext(true));
        ...
        private function enterFrameHandler(e:Event):void 
        {
            ...
            soundArray[0].volume = (name=="day" || name=="night")? 1 - rate : rate; day.soundTransform = stDay;
            soundArray[1].volume = 1 - soundArray[0].volume; evening.soundTransform = stEvening;
            soundArray[2].volume = 0; night.soundTransform = stNight;
