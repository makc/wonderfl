...
package {
    ...
    public class Marimo extends Sprite {
        ...
        * マリモをリアルタイムに作るのは処理が重いので
        * ProgressionのCommandを使って
        * プレレンダリングしています
        * 
        * 超ハイクオリティー版も用意しました
        * http://digg.com/u145Ck
        * 
        * 解説記事
        ...
        */
        ...
        public static const PARTICLE_V:uint = 10;    // 線の勢い。大きいほど長く、粗くなる。
        ...
        public static const COLOR_RANDOM_RATE:Number = 0.2;    // 色のバラつき具合        
        
        public static const GROUND_Y:Number = 400;    // 地面位置    
        public static const SHADOW_W:Number = 200;    // 影サイズ
        public static const GROUND_H:Number = 40;    // 影サイズ
