...
package {
    ...
    public class FlashTest extends Sprite {
        ...
        private function init(e:Event = null):void 
        {
            ...
            loader.load(new URLRequest("http://assets.wonderfl.net/images/related_images/6/65/65fe/65fe0c48bab7478ca37b44bf651c0e1469cf64de"), new LoaderContext(true));
            stage.addChild(loader); bkg.push(loader);
            ...
            if (rpg && explosionData && rpgFrame >= delay && int(rpgFrame) <= 11 + delay) {
                ...
                if (mA > 0.3) {
                    ...
                    if (int(rpgFrame) - delay <= 3 && Point.distance(kikiCenter, mousePoint) <= hitTestRadius && !hitFlag) {
                        kikiLifePoint -= 20; kikiJustDied = (kikiLifePoint <= 0);
