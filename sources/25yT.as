...
package
{
    ...
    {
        private const BMP_PATH:String = "http://ctrlcodes.com/wonderfl/assets/65465/stelarc2.jpg";
        ...
        private const MP3_PATH:String = "http://ctrlcodes.com/wonderfl/assets/65465/435.mp3";
        ...
        override protected function onInit():void
        {
            ...
            Security.loadPolicyFile("http://ctrlcodes.com/crossdomain.xml");
            setProgressBar();
        ...
        private function update(event:Event):void 
        {
            ...
            camera.x += (_cameraX - camera.x) * 1.9;
