...
//*/
        ...
        private var _mesh:Mesh = new Knot(2, 3, 96, 10, 3/5, 0);//i/60);
        ...
        private var _col:uint = 0xFFD059;
        ...
        private function draw(e:Event) : void {
            ...
            // if(!_sc) { 
            //     _sc　=　new BitmapData(465,　465,　false);
            //     addChildAt(new Bitmap(_sc), 0);
