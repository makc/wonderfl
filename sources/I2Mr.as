...
// Bug fixes:
// * x and y coordinates in R, G and B screens were flipped (fixed in _updatePointer and _onCtrlChange).
// * Control pads weren't being updated after changing the color using the text field (fixed in onColorsAddedToStage).
// * ColorChooser::placeColors was using _colorsContainer.height to reposition it when _popupAlign == TOP,
//   ending up with a large negative y coordinate (added override).
// * Removed unused frocessing import (thanks makc).
...
package {
    ...
    public class main extends Sprite {
        function main() {
            new ColorChooserEx(this, 10, 10, 0x4488ff);
        }
    }
}
...
//-------------------------------------------------- constants
    public static const PANEL_WIDTH:Number = 160;
    public static const PANEL_HEIGHT:Number = 134;
...
//-------------------------------------------------- for interactive selectors
    public function browseColorChoiceEx(col:uint) : void { value = _tmpColorChoice = col; }
