...
package 
{
  ...
  [SWF(backgroundColor="0x0", frameRate="60")]
	public class  MyFirstForceMap extends Sprite
	{
		...
		private const RESI:Number = 1.0/250.0; //抵抗の大きさ0~255に掛ける正の値
		...
		private const bmp:Bitmap = new Bitmap(dat);
			...
			fm.perlinNoise(100, 100, 5, rnd, true, false, 7);
                        //fm.fillRect(new Rectangle(WH>>3,WH>>3,WH>>1,WH>>1),0xff408020);
		...
		public function MyFirstForceMap() {
			...
			var resist:Number;
                        ...
                        const ct: ColorTransform = new ColorTransform(1, 1, 1, 1, -7, -3, -2, 0);
