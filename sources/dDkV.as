package {
    ...
    /**
     * Software rendering in ActionScript3.0 #2
     * @author saharan
     */
    public class FlashSoft3D extends Sprite {
        ...
        private function frame(e:Event = null):void {
            ...
            for (var i:int = 0; i < num; i++) {
                Renderer.color = hsv(i / num * 360 + count * 5, 1, 1);
                r.push();
                r.rotateY(Math.PI / num * 0.5 * i + count / 50);
                r.rotateX(Math.PI / num * 0.5 * i + count / 100);
                box(12, 10, 8);
                r.pop();
            }
            r.endScene();
