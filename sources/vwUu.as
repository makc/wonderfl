...
package {
    ...
    public class FlashTest extends Sprite {
        ...
        public function FlashTest() {
            // write as3 code here..
            //emitter = new Emitter();
            emitter = new Emitter(0,0,0,-20,0,0.98,0.98,0.98,0,2,6,60,1.0);
            ...
            addEventListener(Event.ENTER_FRAME,function(e:Event):void
            {
                ...
                for(iParticles = 0; iParticles < particlesLength; iParticles++)
                {
                    ...
                    canvas.setPixel32(emitter.particles[iParticles].x, emitter.particles[iParticles].y, 255 << 24 | 255 << 16 | r * r * 255 << 8 | r * r * r * r * 255);
