// forked from tmeier42's forked from: Interactive Pythagoras Tree
...
package {
    ...
    public class FlashTest extends Sprite {
        ...
        private function ptree (at:Point, up:Point, g:Graphics):void {
            ...
            s1.x = (r.x - left.x) * 0.5; s1.y = (r.y*scale - left.y) * 0.5;
            s2.x = (r.x + left.x) * 0.5; s2.y = (r.y*scale + left.y) * 0.5;
        ...
        private function onEnterFrame (e:*):void {
            ...
            scale = 0.2 + 1.6 * (mouseY / stage.stageHeight);
