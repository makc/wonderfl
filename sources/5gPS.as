// Realtime zoomer to makc house :)
// move your mouse right/left to zoom in/out
//
// Sorry for shitty quality, again, but... 500KB limit 
package {
	...
	public class Zoomer extends Sprite {
		...
		private function onComplete (e:Event):void {
			...
			bmp.transform.colorTransform = new ColorTransform (1, 1.2, 1.5, 1, -100);
			addChild (bmp);
		...
		public function Zoomer () {
			...
			loader.load (new URLRequest ("http://assets.wonderfl.net/images/related_images/6/6b/6b31/6b31d3c97d71b584a761485c76e09c24b4040bdf"),
