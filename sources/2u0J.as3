...
package 
{
	...
	public class CCDPool extends Sprite
	{
		...
		private function initSimulation() : void
		{
			...
			simulator.addParticle( new Particle(232, 230, 0, 0, 1, 10 ) );
			
			for (var i:int = 0; i < 10; i++) {
				for (var j:int = 0; j < i; j++) {
					var px:Number = 282 + 18 * i, py:Number = 240 + 21 * j - 10 * i;
					simulator.addParticle (new Particle (px, py, 0, 0, 1, 10));
					simulator.addParticle (new Particle (465 - px, py, 0, 0, 1, 10));
				}
			}
