...
package
{
    ...
    public class MineStepper extends Sprite
    {
        ...
        private function init(e:Event = null):void
        {
            ...
            {
                cells[i].addEventListener(MouseEvent.MOUSE_DOWN, putFlag);
            }
            ...
            twitter.addEventListener(MouseEvent.MOUSE_UP, function(e:MouseEvent):void
            {
                ...
                {
                    twitter.y -= 2;
                    var post:String = "MineStepperを" + timer.time / 1000 + "秒でクリアしました！ #MineStepper http://wonderfl.net/c/reNm0/";
        ...
        private function putFlag(e:MouseEvent):void
        {
            if (isEnd) return;
...
class GameTimer extends NumberBoard
{
    ...
    public function reset():void
    {
        ...
        spDigits[0].graphics.copyFrom(numsrc[0].graphics);
        spDigits[1].graphics.copyFrom(numsrc[0].graphics);
        spDigits[2].graphics.copyFrom(numsrc[0].graphics);
    }
