...
package
{
    ...
    public class AAShip extends Sprite
    {
        ...
        private function onEnterFrame(event:Event):void
        {
            ...
            var e:Enemy;
            var ei:int = 30 / enemyIntervalRank;
            if (ei < 5) ei = 5;
            if (stageTicks % ei == 0)
            {
        ...
        private function addBlursOfAAChar(ac:AAChar, p:Vector2, angle:Number, sx:Number = 1, sy:Number = 1):void
        {
