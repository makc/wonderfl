// forked from makc3d's Another Alternativa3D maze :)
...
package
{
	...
	public class Maze extends Sprite
	{
		...
		public function Maze()
		{
			...
			wasd = new CameraControllerDvorak (stage); wasd.camera = view.camera; 
...
class CameraControllerDvorak extends alternativa.engine3d.controllers.CameraController {
  public function CameraControllerDvorak(eventsSourceObject:flash.display.DisplayObject) {
    super(eventsSourceObject);
  }

  public override function setDefaultBindings():void {
    super.setDefaultBindings();
    bindKey(0xbc, ACTION_FORWARD); // W
    bindKey(0x4f, ACTION_BACK);    // S
    bindKey(0x45, ACTION_RIGHT);   // D
    bindKey(186, ACTION_DOWN);    // Z
  }
}
