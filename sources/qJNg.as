...
package 
{
  ...
  [SWF(backgroundColor="0x0", frameRate="60")]
	public class  MyFirstForceMap extends Sprite
	{
		...
		private const RESI:Number = 1.0/300.0; //抵抗の大きさ0~255に掛ける正の値
		...
		public function MyFirstForceMap() {
			...
			fm.perlinNoise(400, 400, 3, rnd, true, false, 7);
                        fm.fillRect(new Rectangle(WH>>2,WH>>2,WH>>1,WH>>1),0xff408080);
			...
			var resist:Number;
                        ...
                        const ct: ColorTransform = new ColorTransform(1, 1, 1, 1, -1, -5, -2, 0);
