...
package
{
  ...
  public class Ground extends Sprite
  {
    ...
    private const BACK_R:int = 210, BACK_G:int = 190, BACK_B:int = 240;
    private var buffer:BitmapData;
    private var left:Boolean, up:Boolean, right:Boolean, down:Boolean;
    ...
    {
      buffer.fillRect(buffer.rect, BACK_R * 0x10000 + BACK_G * 0x100 + BACK_B);
      goForward(3.3);
