 ...
 *
 * セルフフォークで、パラメータが時間と共に変わるバージョン。
 * これは好みが分かれるところですねえ。
 * 
 * 結構動くのでパーティクル数を増やしました。重いですか？
 *
 * 1点に収束してしまうと、その後パラメータが動いてもパーティクルが拡散しづらくなるので、
 * 毎フレームパーティクルの座標値にわずかな乱数を加えています。
 * 
 * @author alumican.net
 */
package {
    ...
    public class FlashTest extends Sprite {
        ...
        private var _trans:ColorTransform = new ColorTransform(0.95, 0.95, 0.95);
