// forked from greentec's Lonely Planet 2
...
package  
{
    ...
    public class SphereTexture extends Sprite
    {
        ...
        private function initMaterial():void
       {
           ...
           noiseBitmapData.perlinNoise(_width / 11, _height / 11, 7, Math.random() * int.MAX_VALUE, true, true, 7, true);
        ...
        private function onMouseDown(e:MouseEvent):void
        {
           ...
           var y:Number;
            ...
            noiseBitmapData.perlinNoise(_width / scale, _height / scale, 7, Math.random() * int.MAX_VALUE, true, true, 7, true);
            var offset:int = 10 + int(Math.random() * 80);
