...
package
{
	...
	public class Main extends Sprite 
	{
		...
		{
			this.cameraPosition.xAc = Math.random() * 10 - 5;
			this.cameraPosition.yAc = Math.random() * 10 - 5;
			this.cameraPosition.zAc = Math.random() * 10 - 5;
		...
		private function setPosition():void
		{
			...
			for (var i:int = 0; i < this.lines.length; i++)
			{
				...
				tmpLine.xAc = (Math.random() * 20 - 10) + this.cameraPosition.xAc;
				tmpLine.yAc = (Math.random() * 20 - 10) + this.cameraPosition.yAc;
				tmpLine.zAc = (Math.random() * 20 - 10) + this.cameraPosition.zAc;
				if (a.length)
				{
					var xDiff:Number = this.cameraPosition.x - a[lastLineNum].xAc;
					var yDiff:Number = this.cameraPosition.y - a[lastLineNum].yAc;
					var zDiff:Number = this.cameraPosition.z - a[lastLineNum].zAc;
