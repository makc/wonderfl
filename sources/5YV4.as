package {
     ...
     * @see http://aquioux.net/blog/?p=3824
     * @author YOSHIDA, Akio
     */
    public class Main extends Sprite {
        ...
        public function Main() {
            ...
            const CENTER_Y:Number = stage.stageHeight * 7 / 12;
            ...
            const LENGTH:int = stage.stageWidth * 1.25 >> 0;
            ...
            // 正接円の描画
            drawCircle(circleA, FILL_COLOR);
            drawCircle(circleB, FILL_COLOR);
            drawCircle(circleC, FILL_COLOR);

            // 内接円の生成と描画（再帰処理）
            drawInnerCircles(circleA, circleB, circleC);
        }
