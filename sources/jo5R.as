...
package {
    ...
    public class Main extends Sprite {
        ...
        public function Main():void {
            ...
            bmd_ = new BitmapData(W/2, H/2, false, 0x0);
            with (addChild (new Bitmap (bmd_))) { scaleX = 2; scaleY = 2; }
            
            hslider = new HSlider (this, 20, 20, button2Handler);
            hslider.width = 465 - 40;
            hslider.minimum = 1.99;
            hslider.maximum = 2.05;
            hslider.tick = 0.00001;
            hslider.value = 2.0;
