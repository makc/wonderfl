...
package {
    ...
    public class MathMusic extends Sprite {
        ...
        private static const FORMULAS:Array = [
            ...
            't * (t >> ((t >> 9 | t >> 8)) & 63 & t >> 4)',
            '((7&(((t>>17)+1)>>2)+((t>>10)&1+2*(t>>18&1))*(("23468643".charCodeAt(7&t>>12)-48)+(3&t>>11))+((3&t>>17)>0?1:0)*(3&t>>9)*(!(1&t>>10)?1:0)*(((2+t>>10&3)^(2+t>>11&3))))*t*"@06+".charCodeAt(3&t>>15)/32)'
        ];
        ...
        private function _onSampleData(e:SampleDataEvent):void {
            ...
            for (i = 0; i < 8192; i++, _t++) {
                ...
                switch (_type) {
                    ...
                    case 7: tt = ((7&(((t>>17)+1)>>2)+((t>>10)&1+2*(t>>18&1))*(("23468643".charCodeAt(7&t>>12)-48)+(3&t>>11))+((3&t>>17)>0?1:0)*(3&t>>9)*(!(1&t>>10)?1:0)*(((2+t>>10&3)^(2+t>>11&3))))*t*"@06+".charCodeAt(3&t>>15)/32); break;
                }
                tt &= 0xff;
                val = tt / 0xff;
