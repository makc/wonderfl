...
//			g.drawRect(-50, -50, 100, 100);
			...
			this._filters = [];
			this._filters.push(new BlurFilter(16, 16, BitmapFilterQuality.LOW));
			var a:Number = 1;
			var b:Number = -0;
			...
			this._phongMap = this._createPhongMap(0xffffff, 20, 0x00aaff, 0x00000);
		...
		private function _update(e:Event):void {
			...
			var n:int = 3;	while (n--)	this._waveMap.push(this._waveMap.shift());
