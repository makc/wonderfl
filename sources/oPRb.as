...
package {
    ...
    public class main extends Sprite {
        ...
        function main() {
            ...
            bmp.x = bmp.y = 32;
            initTexMap();
            label.autoSize = "left", label.textColor = 0x0, label.text = "seed : ";
            input.textColor = 0xF, input.type = "input", input.restrict = "0-9";
            ...
            labelwater.autoSize = "left", labelwater.textColor = 0x0000a0, labelwater.text = "waterlevel : "; labelwater.x = 150;
            inputwater.textColor = 0x0000a0, inputwater.type = "input", inputwater.restrict = "0-9";
            ...
            labelflora.autoSize = "left", labelflora.textColor = 0x00a000, labelflora.text = "flora : "; labelflora.x = 300;
            inputflora.textColor = 0x00a000, inputflora.type = "input", inputflora.restrict = "0-9";
        ...
        private function initMap(s: int = 0, w: int = 0, f: int = 0): void {
            ...
            input.text = "" + seed;
            var waterlevel: int = w || Math.random() * 29;
                    ...
                    for ( var d:int = 0; d < 3; d++) {
                        ...
                        while (dist < closest) {
                            ...
                            if (tex > 0) {
                                ...
                                if (d == 1)
                               { 
                                    tex = map[(zp & 127) << 12 | ((yp-1) & 63) << 6 | (xp & 63)];
                                    if (tex > 0)
                                        br *= 0.4;
                                    else
                                   {                                                    
